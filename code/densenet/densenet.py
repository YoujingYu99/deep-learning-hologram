...
class DenseNet(tf.keras.Model, ABC):
    def __init__(self, num_init_features, growth_rate, block_layers, compression_rate, drop_rate):
        ...
        self.dense_block_5 = DenseBlock(num_layers=block_layers[1], growth_rate=growth_rate, drop_rate=drop_rate)
        self.num_channels += growth_rate * block_layers[1]
        self.num_channels = compression_rate * self.num_channels
        self.transition_5 = TransitionLayerup(out_channels=int(self.num_channels))
        self.dense_block_6 = DenseBlock(num_layers=block_layers[2], growth_rate=growth_rate, drop_rate=drop_rate)
        self.num_channels += growth_rate * block_layers[2]
        self.num_channels = compression_rate * self.num_channels
        self.transition_6 = TransitionLayerup(out_channels=int(self.num_channels))

        # pooling up
        self.dense_block_7 = DenseBlock(num_layers=block_layers[0], growth_rate=growth_rate, drop_rate=drop_rate)
        self.num_channels += growth_rate * block_layers[0]
        self.num_channels = compression_rate * self.num_channels
        self.transition_7 = TransitionLayerup(out_channels=int(self.num_channels))
        self.dense_block_8 = DenseBlock(num_layers=block_layers[1], growth_rate=growth_rate, drop_rate=drop_rate)
        self.num_channels += growth_rate * block_layers[1]
        self.num_channels = compression_rate * self.num_channels
        self.transition_8 = TransitionLayerup(out_channels=int(self.num_channels))
        self.dense_block_9 = DenseBlock(num_layers=block_layers[2], growth_rate=growth_rate, drop_rate=drop_rate)
        self.num_channels += growth_rate * block_layers[2]
        self.num_channels = compression_rate * self.num_channels
        self.transition_9 = TransitionLayerup(out_channels=int(self.num_channels))
        self.dense_block_10 = DenseBlock(num_layers=block_layers[3], growth_rate=growth_rate, drop_rate=drop_rate)
        self.num_channels += growth_rate * block_layers[0]
        self.num_channels = compression_rate * self.num_channels
        self.transition_10 = TransitionLayerup(out_channels=int(self.num_channels))
        self.dense_block_11 = DenseBlock(num_layers=block_layers[1], growth_rate=growth_rate, drop_rate=drop_rate)
        self.num_channels += growth_rate * block_layers[1]
        self.num_channels = compression_rate * self.num_channels
        self.transition_11 = TransitionLayerup(out_channels=int(self.num_channels))
        self.dense_block_12 = DenseBlock(num_layers=block_layers[2], growth_rate=growth_rate, drop_rate=drop_rate)
        self.num_channels += growth_rate * block_layers[2]
        self.num_channels = compression_rate * self.num_channels
        self.transition_12 = TransitionLayerup(out_channels=int(self.num_channels))
        self.dense_block_13 = DenseBlock(num_layers=block_layers[2], growth_rate=growth_rate, drop_rate=drop_rate)
