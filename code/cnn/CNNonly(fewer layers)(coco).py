...
# layers reduced by having a less deepes U net 256-128-64-32-16
...
def downsample(filters=K, size=3, input_shape=[]):
...
# checkpoint
filepath="CNNonly(fewer layers)(coco)_model_1"
...
history = generator.fit(train_dataset, epochs=200,
