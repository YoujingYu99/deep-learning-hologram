...
def Generator():
    ...
    while n != 1:
        if n == N:
            down_stack.append(downsample(input_shape=[n, n, 3]))
        else:
...
def Discriminator():
    ...
    down1 = downsample(filters=64, size=4, input_shape=[256, 256, 6], apply_batchnorm=False)(x)  # (bs, 128, 128, 64)
...
checkpoint_dir = './piao3_training_checkpoints'
